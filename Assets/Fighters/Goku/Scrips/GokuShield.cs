...
public class GokuShield : MonoBehaviour, Shieldable
{
    ...
    void Start()
    {
        ...
        fighterAttack = GetComponent<GokuAttack>();
        fighterHealth = GetComponent<GokuHealth>();
        fighterMovement = GetComponent<GokuMovement>();
